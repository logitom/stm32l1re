...
* @retval None.
*/
void SdkEvalTimersTimConfig(TIM_HandleTypeDef* TIM_TimeBaseStructure,
                            uint16_t nPrescaler, uint16_t nPeriod)
{
  ...
  /* NVIC configuration */
  if(xTim == TIM2) {
    HAL_NVIC_SetPriority(TIM2_IRQn, 0x09, 0);
    ...
    HAL_NVIC_SetPriority(TIM7_IRQn, 0x09, 0);
